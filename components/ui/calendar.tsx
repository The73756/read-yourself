  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-brown text-white hover:bg-brown/90 hover:text-white focus:bg-brown focus:text-white dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today:
