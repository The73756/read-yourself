...
export const EditBookList = ({ setOpen }: EditBookListProps) => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    console.log(values);
    setEditBook(allBooks.find((book) => book.title === values.book));
    form.reset({
      book: "",
    });
  }
  ...
  return (
    <>
      ...
      {editBook && (
        <EditBookForm key={editBook.id} book={editBook} setOpen={setOpen} />
      )}
    </>
  );
};
